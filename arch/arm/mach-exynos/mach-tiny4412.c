...
#define TS_INT_GPIO		EXYNOS4_GPX1(6)
#define TS_IRQ_CFG		S3C_GPIO_SFN(0xf)
#endif

static void inline tiny4412_ts_gpio_init(void) {
#ifdef TS_INT_GPIO
	s3c_gpio_cfgpin(TS_INT_GPIO, TS_IRQ_CFG);
	s3c_gpio_setpull(TS_INT_GPIO, S3C_GPIO_PULL_NONE);
#endif
}
